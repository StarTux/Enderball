...
public enum Nation {
    ...
    ARGENTINA("Argentina", "H4sIAAAAAAAA/43JsQrCMBRG4b9NxRjFF/BNHLXdHcS13MY0BuMNJLeDr+ETS8HBSTzb4TOAwroloYvLJSQGNi+NOlyxewR2NtMo+xj8TfohTq4fiNllAyXkDbaHmOy9YwnyPJNfQZ9IxGUuBkCjsfw8alsUFscUU8bcf6TGmL6s+WlANe/EUuENbFXwAdgAAAA=",
              Mytems.ARGENTINA),
    JAPAN("Japan", "H4sIAAAAAAAA/43LvQrCMBTF8dNGMUbp6MM4+rE7iKvcxthc2t5AekV8DZ9YCg5182x/fhwHGKwOpHQJeeAkwPptUfINm54l+Ex33T4ja7jWJBKyg1FqHKpdl3x7FGV9nalZwp5INWQZHICZxeLbMDHWBvN96lLGuImVvZ9Q9UMx/vsCijEfogU+I9VCK9IAAAA=", Mytems.JAPAN),
    ;
    ...
    Nation(final String name, final String base64, final Mytems mytems) {
        this.name = name;
        this.base64 = base64;
        // Icon
        this.mytems = mytems;
        this.component = mytems != null
            ? mytems.component
            : Component.empty();
